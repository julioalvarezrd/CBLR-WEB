    ...
    <main className="flex min-h-screen flex-col bg-slate-100 px-6">
      <div className="flex flex-1 items-center justify-center py-12">
        <section className="w-full max-w-xl rounded-2xl border border-slate-200 bg-white p-8 shadow-sm">
          ...
          <p className="mt-8 text-sm font-semibold uppercase tracking-[0.2em] text-red-700">
          ...
          <p className="mt-3 text-sm leading-6 text-slate-600">
            Esta pantalla solo está disponible mientras no exista ningún
            usuario. El primer usuario recibirá un rol normal de base de datos
            con el catálogo actual de permisos.
          </p>
